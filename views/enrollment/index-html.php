...
<legend>Edital n° <?= $edict->edict_number ?>/<?= $edict->validity_year ?></legend>
  ...
  <?php endif; ?>
  <p><a href="http://progep.ufs.br/uploads/page_attach/path/2311/Retifica__o_01_Edital_01-17.pdf" target="_blank">Retificação do Edital n° <?= $edict->edict_number ?>/<?= $edict->validity_year ?></a></p>
